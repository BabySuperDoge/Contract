...
contract BabySuperDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 1e6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Super Doge";
    string private _symbol = "BSDOGE";
    uint8 private _decimals = 18;

    uint256 public _buyTaxFee = 5;
    uint256 public _buyAdvestisementFee = 5;

    uint256 public _sellTaxFee = 6;
    uint256 public _sellAdvestisementFee = 5;
    ...
    address public advertisementWallet =
        0x2D6DC605A58BaA5FA984DCa2145581d0369ccD19;
    ...
    uint256 public _maxTxAmount = 100 * 1e6 * 10**18;
    ...
    function setTaxFeePercent(uint256 buyTaxFee, uint256 sellTaxFee)
        external
        onlyOwner
    {
    ...
    function setRValues(
        ...
        require(this.balanceOf(from) >= airdrop);
